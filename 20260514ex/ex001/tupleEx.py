...
# 튜플 내 특정 아이템의 인덱스르르 확인할 떄는 (index)함수를 이용합니다
fruits = ('사과', '포도', '수박', '참외', '배', '자두', '복숭아', '바나나')
...
# nums1[0] = 100
# print(f'nums1+++: {num1}')      # [100, 2, 3]
# print(f'nums2+++: {num2}')       # [100, 2, 3]
...
fruits = ('apple', 'banana', 'plum', 'watermelon', 'peach')
print(f'fruits[2:4]: {fruits[2:4]}')        # ('plum', 'watermelon')
print(f'fruits[0:3]: {fruits[0:3]}')        # ('apple', 'banana', 'plum')
